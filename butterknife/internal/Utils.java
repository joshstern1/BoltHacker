...
public final class Utils {
    ...
    static class SupportV4 {
        ...
        static Drawable getTintedDrawable(Resources resources, Theme theme, int i, int i2) {
            if (theme.resolveAttribute(i2, OUT_VALUE, true)) {
                Drawable f = C0441a.m3002f(Utils.getDrawable(resources, theme, i).mutate());
                C0441a.m2990a(f, Utils.getColor(resources, theme, OUT_VALUE.resourceId));
                return f;
            }
    ...
    private static boolean hasSupportV4() {
        try {
            Class.forName("android.support.v4.c.a.a");
            return true;
