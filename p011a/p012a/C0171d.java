...
class C0171d {
    ...
    public static class C0170b {
        ...
        private C0170b(char c, float[] fArr) {
            this.f795a = c;
            this.f796b = fArr;
        }

        private C0170b(C0170b c0170b) {
            this.f795a = c0170b.f795a;
            this.f796b = C0171d.m1053b(c0170b.f796b, 0, c0170b.f796b.length);
        }

        public static void m1045a(C0170b[] c0170bArr, Path path) {
            float[] fArr = new float[6];
            char c = 'm';
            for (int i = 0; i < c0170bArr.length; i++) {
                C0170b.m1044a(path, fArr, c, c0170bArr[i].f795a, c0170bArr[i].f796b);
                c = c0170bArr[i].f795a;
            }
        }

        private static void m1044a(Path path, float[] fArr, char c, char c2, float[] fArr2) {
            int i;
            float f = fArr[0];
            float f2 = fArr[1];
            float f3 = fArr[2];
            ...
            while (i2 < fArr2.length) {
                ...
                switch (c2) {
                    case 'A':
                        ...
                        C0170b.m1043a(path, f10, f9, f5, f2, f, f11, f12, z, z2);
                        f3 = fArr2[i2 + 5];
                        f4 = fArr2[i2 + 6];
                        f6 = f7;
                        f5 = f8;
        ...
        private static void m1043a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            if (d10 < 0.0d) {
                ...
                C0170b.m1043a(path, f, f2, f3, f4, f5 * sqrt, f6 * sqrt, f7, z, z2);
                return;
            }
            d9 = Math.sqrt(d10);
            d5 *= d9;
            ...
            d = ((double) f5) * d6;
            d5 *= (double) f6;
            C0170b.m1042a(path, (d * cos) - (d5 * sin), (d * sin) + (d5 * cos), (double) f5, (double) f6, (double) f, (double) f2, toRadians, d7, d4);
        }

        private static void m1042a(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
    ...
    private static float[] m1053b(float[] fArr, int i, int i2) {
        if (i > i2) {
    ...
    public static C0170b[] m1050a(String str) {
        if (str == null) {
            return null;
        }
        ...
        int i2 = 0;
        while (i < str.length()) {
            int a = C0171d.m1046a(str, i);
            String trim = str.substring(i2, a).trim();
            if (trim.length() > 0) {
                C0171d.m1048a(arrayList, trim.charAt(0), C0171d.m1052b(trim));
            }
            i = a + 1;
            i2 = a;
        }
        if (i - i2 == 1 && i2 < str.length()) {
            C0171d.m1048a(arrayList, str.charAt(i2), new float[0]);
        }
        return (C0170b[]) arrayList.toArray(new C0170b[arrayList.size()]);
    }

    public static C0170b[] m1051a(C0170b[] c0170bArr) {
        if (c0170bArr == null) {
            return null;
        }
        C0170b[] c0170bArr2 = new C0170b[c0170bArr.length];
        for (int i = 0; i < c0170bArr.length; i++) {
            c0170bArr2[i] = new C0170b(c0170bArr[i]);
        }
        return c0170bArr2;
    }

    private static int m1046a(String str, int i) {
        while (i < str.length()) {
    ...
    private static void m1048a(ArrayList<C0170b> arrayList, char c, float[] fArr) {
        arrayList.add(new C0170b(c, fArr));
    }

    private static float[] m1052b(String str) {
    ...
    private static void m1047a(java.lang.String r7, int r8, android.support.p011a.p012a.C0171d.C0169a r9) {
        /*
        r1 = 0;
        r5 = 1;
        r9.f794b = r1;
    ...
    L_0x0033:
        ...
        goto L_0x0008;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.a.a.d.a(java.lang.String, int, android.support.a.a.d$a):void");
    }
}
